...
export default function Competitions() {
	...
	<section className="breadcrumb-area play">
		<img className="bc-img" src="assets/images/breadcrumb/play.png" alt="" />
						...
						<div className="col-lg-12 text-center">
							...
							<li className="nav-item">
								<Link className="nav-link active" id="pills-tab1-tab" data-toggle="pill" to="#pills-tab1" role="tab" aria-controls="pills-tab1" aria-selected="true">
									<div className="icon">
										<img className="one" src="assets/images/play/ic6.png" alt="" />
										<img className="two" src="assets/images/play/ic66.png" alt="" />
									</div>
									<span>All Games</span>
								</Link>
							</li>
							<li className="nav-item">
								...
								<div className="icon">
									<img className="one" src="assets/images/play/ic1.png" alt="" />
									<img className="two" src="assets/images/play/ic11.png" alt="" />
								</div>
								<span>Active</span>
								</Link>
							</li>
							<li className="nav-item">
								...
								<div className="icon">
									<img className="one" src="assets/images/play/ic2.png" alt="" />
									<img className="two" src="assets/images/play/ic22.png" alt="" />
								</div>
								<span>Archived</span>
								</Link>
							</li>
